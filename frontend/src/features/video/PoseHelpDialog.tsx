...
const HELP_SECTIONS: HelpSection[] = [
  {
    ...
    content: [
      ...
      '4. Review the video and suggestions.',
      '5. Set segment start and end frames.',
      '6. Assign Falling, Running, or Others.',
      '7. Accept, edit, or reject suggestions.',
  ...
  },
  {
    ...
    content: [
      ...
      'Suggestions are never saved as human labels until you Accept or Modify them.',
      'Accept copies a suggestion unchanged. Modify saves your edited frames or class. Reject records that it should not be used.',
